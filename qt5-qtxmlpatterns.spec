...
# Source0-md5:	857e8040b2bf45c114a7d75ec6ef94ee
...
%{__rm} $RPM_BUILD_ROOT%{_datadir}/qt5/translations/{assistant,designer,linguist,qmlviewer,qt,qtbase,qtconfig,qtconnectivity,qtdeclarative,qtlocation,qtmultimedia,qtquick1,qtscript}_*.qm
%endif
